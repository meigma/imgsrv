...
// PublishVersion provides a mock function for the type MockStore
func (_mock *MockStore) PublishVersion(context1 context.Context, publishVersionParams catalog.PublishVersionParams) (catalog.Version, error) {
...
// MockStore_PublishVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PublishVersion'
type MockStore_PublishVersion_Call struct {
	*mock.Call
}
...
func (_e *MockStore_Expecter) PublishVersion(context1 interface{}, publishVersionParams interface{}) *MockStore_PublishVersion_Call {
	return &MockStore_PublishVersion_Call{Call: _e.mock.On("PublishVersion", context1, publishVersionParams)}
}

func (_c *MockStore_PublishVersion_Call) Run(run func(context1 context.Context, publishVersionParams catalog.PublishVersionParams)) *MockStore_PublishVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockStore_PublishVersion_Call) Return(version catalog.Version, err error) *MockStore_PublishVersion_Call {
	_c.Call.Return(version, err)
	return _c
}

func (_c *MockStore_PublishVersion_Call) RunAndReturn(run func(context1 context.Context, publishVersionParams catalog.PublishVersionParams) (catalog.Version, error)) *MockStore_PublishVersion_Call {
	_c.Call.Return(run)
	return _c
}
